...
import * as Plugin_0 from 'E:/ragflow/web/src/app.tsx';
import * as Plugin_1 from '@@/core/helmet.ts';
import * as Plugin_2 from 'E:/ragflow/web/src/.umi/plugin-clickToComponent/runtime.tsx';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : 'E:/ragflow/web/src/app.tsx',
    },
    {
      apply: Plugin_1,
    ...
    {
      apply: Plugin_2,
      path: process.env.NODE_ENV === 'production' ? void 0 : 'E:/ragflow/web/src/.umi/plugin-clickToComponent/runtime.tsx',
    },
  ];
}
